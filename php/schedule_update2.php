...
try{
  ...
  if(isset($_POST['update'])){
    $stt = $db->prepare('UPDATE schedule SET live_date=:live_date, live_house_name=:live_house_name, live_house_tel1=:live_house_tel1, live_house_tel2=:live_house_tel2, live_house_tel3=:live_house_tel3, open_time=:open_time, start_time=:start_time, live_member_name1=:live_member_name1, live_member_name2=:live_member_name2, live_member_name3=:live_member_name3, live_member_name4=:live_member_name4, live_member_name5=:live_member_name5, live_member_name6=:live_member_name6, live_member_name7=:live_member_name7, leader_live=:leader_live, remarks=:remarks WHERE schedule_id=:schedule_id');
    ...
    $stt = $db->prepare('DELETE FROM schedule WHERE schedule_id=:schedule_id');
    // $stt->bindValue(':schedule_id', $_POST['schedule_id']);
  }
  $stt->bindValue(':schedule_id', $_POST['schedule_id']);
  // $stt->debugDumpParams();
  $stt->execute();
